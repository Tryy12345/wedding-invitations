...
(function () {
  var cards = document.querySelectorAll('.tr-dcard[data-scratch]');
  var dateSection = document.querySelector('.tr-date');
  ...
  cards.forEach(function (card) {
    ...
    function paintCoat() {
      ...
      grad.addColorStop(0, '#e4cabb');
      grad.addColorStop(1, '#a8694f');
      ctx.fillStyle = grad;
...
(function () {
  var form = document.querySelector('.tr-rsvp-form');
  if (!form) return;

  var choices = form.querySelectorAll('.tr-choice');
  var nameInput = form.querySelector('#rsvp-name');
  var submit = form.querySelector('.tr-submit');
  var selected = null;
...
(function () {
  var btn = document.getElementById('trMusic');
  var audio = document.getElementById('trAudio');
  if (!btn || !audio) return;
